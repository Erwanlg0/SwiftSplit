package com.elg.speedruncompanion.ui.screen.runs.components
        ...
        Column(
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = stringResource(com.elg.speedruncompanion.R.string.timer_attempts, run.attemptCount),
                ...
                Text(
                    text = pbTime?.formatted() ?: stringResource(com.elg.speedruncompanion.R.string.runs_list_no_pb),
                    style = MaterialTheme.typography.titleMedium,
                    fontWeight = FontWeight.Bold,
